		...
		<h1>Articulo Destacado</h1>
				...
				<article class="prodest">
					...
					<section class="descrip">
						<nombre><a href="index.php?cat=mont_22">Monitor Samsung 22 Pulgadas LED</a></nombre>
						<descripcion><p>Características:-Podras actualizar a un nivel mas avanzado de calidad.</p>
							<p>-Control de brillo auto ajustable para ahorrar energia.</p>
							<p>-Podra sentarse donde cualquier angulo sin tener que perder visión.</p>
						</descripcion>
						<precio>74€</precio>
					</section>
					</articulo>
